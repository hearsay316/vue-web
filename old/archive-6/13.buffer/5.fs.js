...
// 文件的操作
// 创建目录 mkdir rmdir readdir  删除目录  读取目录
// fs.stat 
...
//         await unlink(dir);
//     }else{
//         let dirs =  await readdir(dir); // generator await是他的语法糖
...
function wide(dir){
    ...
    while(current = arr[index++]){
        ...
        dirs = dirs.map(item=>path.join(current,item)); // [a,a/b,a/c,a/b/d,a/c/e,a/c/f]
        arr = [...arr,...dirs];
    }
    // 循环arr删除即可  
}
