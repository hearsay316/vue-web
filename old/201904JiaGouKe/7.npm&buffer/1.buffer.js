...
//截取的乱码问题
let buf10 = Buffer.from('珠峰架构');
//console.log(buf10.slice(3,7).toString());
//console.log(buf10.slice(7).toString());
let {StringDecoder} = require('string_decoder');
let sd = new StringDecoder();
console.log(sd.write(buf10.slice(3,7)));
console.log(sd.write(buf10.slice(7)));
...
let buffer = Buffer.concat([buf1,buf2]);
